...
public class Compass implements SensorEventListener {
    ...
    public Compass(Context context, double targetLat, double targetLong) {
        ...
        target.setLongitude(targetLong);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        synchronized (this) {
            ...
            if (success) {
                ...
                azimuth -= bearing(cur_lat, cur_long, target.getLatitude(), target.getLongitude());
